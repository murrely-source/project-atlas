...
failures << "hero heading structure is incomplete" unless html.match?(/<div class="page-container hero-layout">\s*<div class="hero-heading">.*?<\/div>\s*<\/div>\s*<\/section>/m)
failures << "removed Hero action region remains" if html.match?(/<div class="hero-support">|<div class="button-group">/)
